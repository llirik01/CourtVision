...
st.markdown("<h1 style='text-align: center; color: black; font-weight: 650;'>🎾 CourtVision – \
            Tennis Match Prediction</h1>", unsafe_allow_html=True)

st.markdown("<h2 style='text-align: left; color: #261324; font-weight: 550;'>🎯 Purpose of the Application</h2>",
            unsafe_allow_html=True)

st.markdown("<p style='text-align: justify; color: #261324; font-weight: normal; font-size: 22px'>CourtVision is an \
...
st.markdown("<h2 style='text-align: left; color: #261324; font-weight: 550;'>🏆 ATP Match Prediction</h2>",
            unsafe_allow_html=True)

st.markdown("<p style='text-align: justify; color: #261324; font-weight: normal; font-size: 22px'>CourtVision analyzes \
            ...
            specifically for a particular surface type (e.g., hard court, clay, or grass).</p>", unsafe_allow_html=True)

st.markdown("<p style='text-align: left; color: #261324; font-weight: bold; font-size: 22px'>📅 Latest database update: \
            24-04-2024</p>", unsafe_allow_html=True)

st.markdown("<h2 style='text-align: left; color: #261324; font-weight: 550;'>🌟 WTA Match Prediction</h2>",
            unsafe_allow_html=True)

st.markdown("<p style='text-align: justify; color: #261324; font-weight: normal; font-size: 22px'>For women's tennis, \
            ...
            starting from 2010.</p>", unsafe_allow_html=True)

st.markdown("<h2 style='text-align: left; color: #261324; font-weight: 550;'>🤖 Machine Learning Models Used</h2>",
            unsafe_allow_html=True)

st.markdown("<ul style='color: #261324; font-size: 22px'> \
...
st.markdown("<h2 style='text-align: left; color: #261324; font-weight: 550;'>🔗 Data Sources</h2>",
            unsafe_allow_html=True)
